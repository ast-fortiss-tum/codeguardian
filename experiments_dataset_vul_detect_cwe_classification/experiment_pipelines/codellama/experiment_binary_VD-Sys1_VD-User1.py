...
def main(model_name, dataset_path):
    ...
    system = "You are an AI binary vulnerability classifier that identifies whether the provided code is vulnerable or not vulnerable. You should respond with either only 'vulnerable' or 'not vulnerable'."
