# Source: Row 4 in ./dataset/CVEfixes/Analysis/results/Python/df_python_cwe_787.xlsx
...
def parse_line(s):
    ...
    if r != s: return r
    r = re.sub(REG_CODE_CHECK, 'if (code == gcode && wordlist[key].index >= 0)', s) # wordlist[key].index >= 0 is added to avoid out-of-bound access
    if r != s: return r
